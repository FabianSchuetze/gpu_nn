...
int main() {
    ...
    MatrixXd gradient_out = MatrixXd::Zero(incoming, obs);
    ...
    inp1 = &d1;
    MatrixXd gradient_out_test =
        inp1->return_parameters()[0]->return_data_const().transpose() *
        gradient;
    ...
    std::cout << "outgoing gradient\n"
              << vec[0]->return_data_const() << std::endl;
    // inp2 = &d2;
