...
void read_test(std::size_t limit, Images& images, Labels& labels,
               Functor func) {
    read_test(
        "/home/fabian/Documents/work/gpu_nn/third_party/cifar10/"
        "cifar-10-batches-bin",
        limit, images, labels, func);
}
...
void read_test_categorical(const std::string& folder, std::size_t limit,
                           Images& images, Labels& labels) {
    read_cifar10_file_categorical(images, labels, folder + "/test_batch.bin",
                                  limit, 0);
}
...
void read_test_categorical(std::size_t limit, Images& images, Labels& labels) {
    read_test_categorical("cifar-10/cifar-10-batches-bin", limit, images,
                          labels);
}
