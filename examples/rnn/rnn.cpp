...
int main(int argc, char** argv) {
    ...
    // std::ifstream t(
    //"/home/fabian/Documents/work/gpu_nn/examples/rnn/input.txt");
    std::ifstream t(
        "/home/fabian/Documents/work/gpu_nn/examples/rnn/shakespeare.txt");
    std::vector<int> vec;
    char c;
    ...
    std::shared_ptr<GradientDescent> sgd =
        std::make_shared<RMSProp>(LearningRate(0.002 * 100), DecayRate(0.95),
